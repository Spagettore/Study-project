...
import hotel.ui.actions.config.SetRoomHistoryCountAction;
import hotel.ui.actions.config.changeAllowRoomStatusAction;
...
public class Builder implements IBuilder {
    ...
    public void buildMenu() {
        ...
        ArrayList<MenuItem> configMenuItemList = new ArrayList<>();
        ...
        Menu configMenu = new Menu("Изменение конфига", configMenuItemList);
        ...
        rootMenuItemList.add(new MenuItem("Изменение конфига", null, configMenu));
        ...
        //конфиг меню
        configMenuItemList.add(new MenuItem("Разрешить менять статус комнаты", new changeAllowRoomStatusAction(), configMenu));
        configMenuItemList.add(new MenuItem("Изменить количество записей выводимых в истории номера", new SetRoomHistoryCountAction(), configMenu));
        configMenuItemList.add(new MenuItem("Назад", null, this.rootMenu));
    }
}
